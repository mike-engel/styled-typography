...
export const RawIndex = ({ className }: Props) => (
	<section className={className}>
		...
		<Text>
			...
			little as you’d like. A default will be provided that looks nice,
			visually.
		</Text>
		<Text>
			The minimum to get started is to have a <code>ThemeProvider</code>{" "}
			somewhere near the top of your react tree. You don’t need to provide a
			theme if you want the default configuration.
		</Text>
...
export const App = ({ children }) => (
	<ThemeProvider theme={{ typography: typographyTheme }}>
		...
		<Text>
			...
			<code>Span</code> or <code>Link</code> outside of <code>Text</code>/
			<code>Heading</code>, or other non-<code>styled-typography</code>{" "}
			components in your app. It’s important, however, that you place it within
			the <code>ThemeProvider</code> component.
		</Text>
		<Code>{`import React from "react";
import { ThemeProvider } from "styled-components";
...
export const App = ({ children }) => (
	<ThemeProvider theme={{}}>
		...
		<Text>
			...
			as well as <code>TextProps</code>.
		</Text>
		<Code>{`import React from "react";
...
export const HelloWorld = ({ className }) => (
	...
	>
		...
		<Text>
			...
			to <code>div</code>, as well as <code>TextProps</code>.
		</Text>
		<Callout>
			<Text>
				But wait, you say! That’s not accessible! I know. By default, a{" "}
				<code>div</code> is not semantically an <code>h1</code> element.{" "}
				<code>ARIA</code>, however, provides attributes that{" "}
				<Span fontStyle={FontStyle.Italic}>can</Span> make it a semantic header.
				Thus, the <code>Header</code> component automatically gets{" "}
				<code>role="heading"</code> and <code>aria-level="#"</code> attributes.
			</Text>
		</Callout>
		<Code>{`import React from "react";
...
export const HelloWorld = ({ className }) => (
	...
	>
		...
		<Text>
			...
			to <code>span</code>, as well as <code>TextProps</code>.
		</Text>
		<Code>{`import React from "react";
...
export const HelloWorld = ({ className }) => (
	...
	>
		...
		<Callout>
			<code>
				<Span fontWeight={FontWeight.Bold}>Default:</Span> ["2.369rem",
				"1.777rem", "1.333rem", "1rem", "0.750rem", "10px"]
			</code>
		</Callout>
		<Text>
			<code>fontSizes</code> controls the 6 font size levels available to you.
			This generally corresponds to <code>h1</code> through <code>h6</code>. 6
			levels are required. If your app has less than that, just duplicate the
			smallest value until there are 6.
		</Text>
		<Text>
			If only having 6 levels doesn’t work for you, please{" "}
			<Link
				href="https://github.com/mike-engel/styled-typography/issues"
				target="_blank"
			>
				file an issue
			</Link>
		...
		<Callout>
			<code>
				<Span fontWeight={FontWeight.Bold}>Default:</Span> "system-ui,
		...
		<Text>
			<code>bodyFontFamily</code> sets the font family for <code>Text</code>{" "}
			elements. <code>Span</code> and <code>Link</code> will inherit the global
		...
		<Text>
			<code>bodySize</code> sets the default font size level for{" "}
			<code>Text</code> elements. <code>Span</code> and <code>Link</code> will
		...
		<Text>
			<code>bodyWeight</code> sets the default <code>font-weight</code> for{" "}
			<code>Text</code> elements. <code>Span</code> and <code>Link</code> will
			inherit the global styles unless used within a <code>Text</code> or{" "}
			<code>Heading</code> element.
		</Text>
		...
		<Text>
			<code>bodyStyle</code> sets the default <code>font-style</code> for{" "}
			<code>Text</code> elements. <code>Span</code> and <code>Link</code> will
			inherit the global styles unless used within a <code>Text</code> or{" "}
			<code>Heading</code> element.
		</Text>
		...
		<Text>
			<code>bodyColor</code> sets the default <code>color</code> for{" "}
			<code>Text</code> elements. <code>Span</code> and <code>Link</code> will
			inherit the global styles unless used within a <code>Text</code> or{" "}
			<code>Heading</code> element.
		</Text>
		...
		<Text>
			<code>bodyColor</code> sets the default <code>line-height</code> for{" "}
			<code>Text</code> elements. <code>Span</code> and <code>Link</code> will
			inherit the global styles unless used within a <code>Text</code> or{" "}
			<code>Heading</code> element.
		</Text>
		...
		<Text>
			<code>headingFontFamily</code> sets the font family for{" "}
			<code>Heading</code> elements. <code>Span</code> and <code>Link</code>{" "}
		...
		<Text>
			<code>headingSize</code> sets the default font size level for{" "}
			<code>Heading</code> elements. <code>Span</code> and <code>Link</code>{" "}
			will inherit the global styles unless used within a <code>Text</code> or{" "}
			<code>Heading</code> element.
		</Text>
		...
		<Text>
			<code>headingWeight</code> sets the default <code>font-weight</code> for{" "}
			<code>Heading</code> elements. <code>Span</code> and <code>Link</code>{" "}
			will inherit the global styles unless used within a <code>Text</code> or{" "}
			<code>Heading</code> element.
		</Text>
		...
		<Text>
			<code>headingStyle</code> sets the default <code>font-style</code> for{" "}
			<code>Heading</code> elements. <code>Span</code> and <code>Link</code>{" "}
			will inherit the global styles unless used within a <code>Text</code> or{" "}
			<code>Heading</code> element.
		</Text>
		...
		<Text>
			<code>headingColor</code> sets the default <code>color</code> for{" "}
			<code>Heading</code> elements. <code>Span</code> and <code>Link</code>{" "}
			will inherit the global styles unless used within a <code>Text</code> or{" "}
			<code>Heading</code> element.
		</Text>
		...
		<Text>
			<code>headingColor</code> sets the default <code>line-height</code> for{" "}
			<code>Heading</code> elements. <code>Span</code> and <code>Link</code>{" "}
			will inherit the global styles unless used within a <code>Text</code> or{" "}
			<code>Heading</code> element.
		</Text>
		...
		<Text>
			<code>extra</code> injects extra styles for each type of component.
			Template strings and plain strings are acceptable values for each key.
		</Text>
	</section>
);
