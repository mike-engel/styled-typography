...
export const RawIndex = ({ className }: Props) => (
	<section className={className}>
		...
		<Text>
			<Span fontWeight={FontWeight.Bold}>styled-typography</Span> is a small set
			of components using{" "}
			<Link href="https://styled-components.com" target="_blank">
				styled-components
			</Link>
			, to better manage typographic styles within your app. The API was born
			out of years of managing large single page applications and design
			systems.
		</Text>
		<Text>
			It’s flexible to be used however you need and to be customized further,
