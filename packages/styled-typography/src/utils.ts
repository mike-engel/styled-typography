...
export const getFontFamily = (type: TextType): InterpolationGetter => props => {
	...
	const defaultFontFamily = getDefault(
		type,
		bodyFontFamily,
		headingFontFamily,
		"inherit"
...
export const getFontWeight = (type: TextType): InterpolationGetter => props => {
	...
	const defaultWeight = getDefault(
		type,
		bodyWeight,
		headingWeight,
		FontWeight.Inherit
...
export const getLineHeight = (type: TextType): InterpolationGetter => props => {
	...
	const defaultLineHeight = getDefault(
		type,
		bodyLineHeight,
		headingLineHeight,
		"inherit"
...
export const getExtras = (type: TextType): InterpolationGetter => props => {
	...
	return (
		getDefault(type, extra.body, extra.heading, extra.span, extra.link) || ``
	);
};
